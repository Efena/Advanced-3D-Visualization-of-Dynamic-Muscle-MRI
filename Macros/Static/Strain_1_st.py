...
# values = input('Insert all quantiles')
# print(values)
# print(values.split())
...
#Setting the input for threshold2
#GM_T1 = float(input('Min GM Threshold'))
#GM_T2 = float(input('Max GM Threshold'))
...
# Properties modified on threshold3
#SL_T1 = float(input('Min SL Threshold'))
#SL_T2 = float(input('Max SL Threshold'))
